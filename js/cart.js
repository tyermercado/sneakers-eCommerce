...
function createCartItem(productDetails) {
  ...
  <div class="checkout-cart__product" data-producttitle="${productDetails.title}">
        <img src="${productDetails.img}" class="checkout-cart__img">
        <div class="checkout-cart__product-details">
            <h4 class="shoes__product-name">${productDetails.title}</h4>
            <p class="shoes__product-cat">${productDetails.cat}</p>
            <p class="shoes__product-size">${productDetails.size}</p>
            <p class="shoes__product-price">$${productDetails.price}</p>
            <br>
